...
For a more in-depth tutorial on circular whole genome comparison see my [circular genome comparisons github repo](https://github.com/rngoodman/circular-genome-comparisons). 

## Part 1 - Genome download and comparison in bash

### 1.1: Download reads and run assemblies

See the [code on how to download reads and run assemblies](https://rngoodman.github.io/blood-faecal-genomic-comparison/genome_assemblies.html)
